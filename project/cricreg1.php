<html>
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if(empty($name)) {
            ...
            $msg4="Reuired section";
            $validate=False;
        }
        else if(empty($role)) {
            $msg5="Enter your role";
            $validate=False;
        }
        else if(empty($phno)) {
        ...
        if($validate == True) {
            ...
            if (!$conn){
                ...
                $sql = "INSERT INTO `cricket` 
                        VALUES ('$name', '$email', '$Bat', '$Bowl', '$role', '$phno' , '$pincode')";
    ...
    <body>
        ...
        <h1>Registration</h1><br>
            ...
            Bat<br>
            <input type="text" id="Bat" name="Bat" size="50">
            <span id="abd"><?php echo $msg3; ?></span><br><br />
            Bowl<br>
            <input type="text" id="Bowl" name="Bowl" size="50">
